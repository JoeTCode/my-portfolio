    ...
    return (
        <div className="grid gap-4 grid-cols-1 mx-[30%] pt-[15rem]">
            ...
            <div>
                Project2
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum convallis ullamcorper augue id ornare.
                Proin at consequat nulla, ut feugiat sem. Aenean lacinia vitae ante eget dictum.
                Morbi enim nibh, lacinia eget luctus eu, vehicula eu mauris.
                Suspendisse nisi nunc, ultrices sit amet nunc ac, consequat elementum metus.
                Proin pretium a massa vel eleifend. Proin malesuada metus id justo ultrices ultrices. 
                Nulla facilisi. Etiam vestibulum ac enim sed porta. Aliquam consequat pellentesque ex eu aliquam.
                Aliquam nibh libero, porttitor in metus at, luctus vestibulum odio. 
                Cras pulvinar nulla at vulputate blandit.
